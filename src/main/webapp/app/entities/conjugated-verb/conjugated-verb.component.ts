...
@Component({
    selector: 'jhi-conjugated-verb',
    templateUrl: './conjugated-verb.component.html'
})
export class ConjugatedVerbComponent implements OnInit, OnDestroy {
    ...
    registerChangeInConjugatedVerbs() {
        this.eventSubscriber = this.eventManager.subscribe('conjugatedVerbListModification', (response) => this.reset());
    }
