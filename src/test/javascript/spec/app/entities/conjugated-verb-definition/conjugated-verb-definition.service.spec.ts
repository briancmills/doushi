...
describe('Service Tests', () => {
    ...
    describe('ConjugatedVerbDefinition Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConjugatedVerbDefinitionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/conjugated-verb-definitions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConjugatedVerbDefinition', () => {
