...
describe('Service Tests', () => {
    ...
    describe('UserVerbFormLevel Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserVerbFormLevelService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-verb-form-levels';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserVerbFormLevel', () => {
